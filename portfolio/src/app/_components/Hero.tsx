...
const Hero = () => {
  return (
    <div className="flex flex-col-reverse bg-primary w-full items-start justify-center gap-4 px-4 pt-[79px] md:gap-12 md:flex-row md:px-12 lg:pt-[89px] 2xl:px-28 2xl:pt-[149px]">
      <div className="flex flex-col w-full py-6 gap-4 md:gap-5 md:w-1/2 2xl:w-[55%] 2xl:gap-10 2xl:py-16">
        ...
        <p className="w-full text-base text-silver md:text-[1.1rem] md:w-[95%] 2xl:w-[78%] 2xl:text-[2.25rem] 2xl:leading-normal">
